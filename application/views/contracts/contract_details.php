    ...
    <div region="north" title="Contract Details" style="height:200px;" collapsible="false">
        ...
        <div class="row" style="padding:10px;margin:0px;">
            <div class="col-md-1">
                ...
                <div class="form-group">
                    <label >Status</label>
                    <input class="easyui-combobox" style="width:100px;" name="c_status"
                           data-options="
                            valueField: 'label',
                            textField: 'value',
            ...
            <div class="col-md-2">
                <div class="form-group">
                    <label >Company</label>
                    <input class="easyui-combobox" style="width:100%;" name="c_cust_id"
                ...
                <div class="form-group">
                    <label >Date</label>
                    <input type="text" name="c_date" class="easyui-textbox" value="<?php echo $contract_details->c_date; ?>" style="width:100%">
                </div>
            </div>
            <div class="col-md-2">
                <div class="form-group">
                    <label >Project</label>
                    <input type="text" class="easyui-textbox"  name="c_project" value="<?php echo $contract_details->c_project; ?>" style="width:100%">
                </div>
                <div class="form-group">
                    <label >Location</label>
                    <input type="text" class="easyui-textbox"  name="c_location" value="<?php echo $contract_details->c_location; ?>" style="width:100%">
                </div>
            </div>
            <div class="col-md-2">
                <div class="form-group">
                    <label >Sales Rep</label>
                    <input type="text"  name="c_sales_rep" class="easyui-textbox" value="<?php echo $contract_details->c_sales_rep; ?>" style="width:100%">
                </div>
                <div class="form-group">
                    <label >Reference</label>
                    <input type="text"  name="c_reference" class="easyui-textbox" value="<?php echo $contract_details->c_reference; ?>" style="width:100%">
                </div>
            </div>
            <div class="col-md-2">
                <div class="form-group">
                    <label>Color</label>
                    <input type="text" class="easyui-combobox input-sm"  name="c_clr_id" style="width:100%"
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="easyui-textbox" name="c_delivery_instruction" value="<?php echo $contract_details->c_delivery_instruction; ?>" style="width:100%">
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
                    <label>Terms of Payment</label>
                    <textarea name="c_terms_of_payment" class="form-control input-sm" rows="5"><?php echo $contract_details->c_terms_of_payment; ?></textarea>
                </div>
            </div>
        </div>
        </form>
